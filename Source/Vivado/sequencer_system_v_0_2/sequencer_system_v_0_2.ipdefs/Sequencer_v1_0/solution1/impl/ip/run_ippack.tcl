...
set Library     "hls"
set IPName      "sequencer"
set Version     "1.0"
set DisplayName "Sequencer"
set Revision    "1604231137"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 C_table_A W 0x0 "Data signal of C_table_A" {{0 32 C_table_A W 0 "Bit 31 to 0 Data signal of C_table_A"}}} {0x18 C_table_C W 0x0 "Data signal of C_table_C" {{0 32 C_table_C W 0 "Bit 31 to 0 Data signal of C_table_C"}}} {0x20 C_table_G W 0x0 "Data signal of C_table_G" {{0 32 C_table_G W 0 "Bit 31 to 0 Data signal of C_table_G"}}} {0x28 C_table_T W 0x0 "Data signal of C_table_T" {{0 32 C_table_T W 0 "Bit 31 to 0 Data signal of C_table_T"}}} {0x30 I_table W 0x0 "Data signal of I_table" {{0 32 I_table W 0 "Bit 31 to 0 Data signal of I_table"}}} {0x38 SR_length W 0x0 "Data signal of SR_length" {{0 32 SR_length W 0 "Bit 31 to 0 Data signal of SR_length"}}} {0x40 ref_length W 0x0 "Data signal of ref_length" {{0 32 ref_length W 0 "Bit 31 to 0 Data signal of ref_length"}}} {0x48 SR W 0x0 "Data signal of SR" {{0 32 SR W 0 "Bit 31 to 0 Data signal of SR"}}} {0x50 done R 0x0 "Data signal of done" {{0 32 done R 0 "Bit 31 to 0 Data signal of done"}}} {0x54 done_ctrl R 0x0 "Control signal of done" {{0 1 done_ap_vld R 0 "Control signal done_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 matched R 0x0 "Data signal of matched" {{0 32 matched R 0 "Bit 31 to 0 Data signal of matched"}}} {0x5c matched_ctrl R 0x0 "Control signal of matched" {{0 1 matched_ap_vld R 0 "Control signal matched_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 final_top_ptr R 0x0 "Data signal of final_top_ptr" {{0 32 final_top_ptr R 0 "Bit 31 to 0 Data signal of final_top_ptr"}}} {0x64 final_top_ptr_ctrl R 0x0 "Control signal of final_top_ptr" {{0 1 final_top_ptr_ap_vld R 0 "Control signal final_top_ptr_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 final_bot_ptr R 0x0 "Data signal of final_bot_ptr" {{0 32 final_bot_ptr R 0 "Bit 31 to 0 Data signal of final_bot_ptr"}}} {0x6c final_bot_ptr_ctrl R 0x0 "Control signal of final_bot_ptr" {{0 1 final_bot_ptr_ap_vld R 0 "Control signal final_bot_ptr_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_ctable_a m_axi_ctable_c m_axi_ctable_g m_axi_ctable_t m_axi_itable m_axi_sr_mem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_ctable_a {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctable_a"
        data_width "32"
        param_prefix "C_M_AXI_CTABLE_A"
    ...
    m_axi_ctable_c {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctable_c"
        data_width "32"
        param_prefix "C_M_AXI_CTABLE_C"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_ctable_g {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctable_g"
        data_width "32"
        param_prefix "C_M_AXI_CTABLE_G"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_ctable_t {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctable_t"
        data_width "32"
        param_prefix "C_M_AXI_CTABLE_T"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_itable {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_itable"
        data_width "32"
        param_prefix "C_M_AXI_ITABLE"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_sr_mem {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_sr_mem"
        data_width "32"
        param_prefix "C_M_AXI_SR_MEM"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
set enable_xo_gen 0
set kernel_files {/home/david/HlsProjects/Sequencer/Sequencer/sequencer.cpp}
if {$enable_xo_gen} {
