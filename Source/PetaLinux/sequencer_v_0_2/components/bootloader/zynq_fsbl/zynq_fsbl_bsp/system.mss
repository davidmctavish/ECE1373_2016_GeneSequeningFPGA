...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_bram_ctrl_ITable
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = axi_bram_ctrl_SR_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = axi_bram_ctrl_SR_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = axi_bram_ctrl_SR_2
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = sequencer
 PARAMETER DRIVER_VER = 1.0
